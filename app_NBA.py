...
file_all_seasons = st.sidebar.file_uploader("all_seasons_filtrado.csv")
file_player = st.sidebar.file_uploader("player_filtrado.csv")
file_team = st.sidebar.file_uploader("team_filtrado.csv")
file_line_score = st.sidebar.file_uploader("line_score_filtrado.csv")
file_game = st.sidebar.file_uploader("game_filtrado.csv")
file_vara = st.sidebar.file_uploader("nba_puntaje_vara.csv")
file_resumen = st.sidebar.file_uploader("resumen.csv")
